...
/**
 * @brief Construit et envoie les mesures moyennes structurées en JSON au serveur Qt.
 *
 * Sérialise les moyennes de tension, courant et puissance dans un document JSON
 * contenant l'action, les valeurs mesurées et l'identifiant de borne, puis transmet
 * la trame via EnvoyerNotification().
 *
 * @param moyenneTension    Moyenne de la tension sur la dernière minute (V).
 * @param moyenneCourant    Moyenne du courant sur la dernière minute (A).
 * @param moyennePuissance  Moyenne de la puissance sur la dernière minute (W).
 */
