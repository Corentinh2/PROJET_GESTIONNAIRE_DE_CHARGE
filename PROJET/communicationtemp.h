...
public:
    ...
    // Fonction appelée par le QML pour envoyer les deux trames (Raspi + ESP)
    ...
    // NOUVEAU : Fonction pour supprimer une session existante (Trame 'S')
    Q_INVOKABLE void supprimerCharge(const QString &borne, const QString &vehicule, const QString &jours, const QString &start, const QString &end);
...
signals:
    ...
    // Signal émis quand on reçoit une trame 's' du serveur
